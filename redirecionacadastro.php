...
<nav class="menu lateral">
    ...
    <div class="container mt-5">
        ...
        <a href="cadastrodeclientes.php" class="btn btn-primary">CADASTRAR CLIENTE</a>
    </div>
    <div class="container mt-5">
            ...
            <table class="table">
                <thead>
                    <tr>
                        <th scoop="col">#</th>
                        <th scoop="col">Nome</th>
                        <th scoop="col">Celular</th>
                        <th scoop="col">Email</th>
                        <th scoop="col">Data de Nascimento</th>
                        <th scoop="col">CPF</th>
                        <th scoop="col">RG</th>
                    </tr>
                </thead>
                ...
                <?php
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['id']) && isset($_GET['action'])) {
                        ...
                        if ($action === 'ocultar') {
                            // Marcar o cliente como oculto
                            $query = "UPDATE clientes SET ocultar = 1 WHERE idcliente = $id";
                            $db->query($query);
                        }
                    }

                    $query = "SELECT * FROM clientes WHERE ocultar = 0 ORDER BY idcliente ASC";
                    ...
                    while ($user_data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td> 
                            <a class='btn btn-primary' href='editacadastro.php?id=$user_data[idcliente]'>
                            <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil-square' viewBox='0 0 16 16'>
                            <path d='M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z'/>
                            <path fill-rule='evenodd' d='M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z'/>
                            </svg>
                            </a>
                            <a class='btn btn-warning' href='?id=$user_data[idcliente]&action=ocultar'>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const arquivarButtons = document.querySelectorAll('.btn-warning');
        arquivarButtons.forEach(function(button) {
            button.addEventListener('click', function(event) {
                event.preventDefault(); 

                if (confirm("Tem certeza de que deseja arquivar este cliente?")) {
