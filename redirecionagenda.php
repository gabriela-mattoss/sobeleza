...
<body>
    ...
    <div class="container mt-5">
        <p>Clique no botão abaixo para agendar um cliente:</p>
        <a href="agendamento.php" class="btn btn-primary">AGENDAR CLIENTE</a>
    </div>
    ...
    <div class="container mt-5">
        ...
        <table class="table">
            ...
            <?php
                    ...
                    $query = "SELECT * FROM agendamento ORDER BY clientes ASC";
